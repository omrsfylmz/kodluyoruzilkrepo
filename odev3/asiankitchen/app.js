...
renderDOM(menu)
function renderDOM(menu) {
  menulist.innerHTML = ''
  menu.map(el => {
    let menuItem = `
      <div class="menu-items col-lg-6 col-sm-12" data-category=${el.category}>
...
KoreaBtn.addEventListener('click', filterDom)
JapanBtn.addEventListener('click', filterDom)
ChinaBtn.addEventListener('click', filterDom)
